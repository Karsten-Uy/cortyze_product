...
It writes `docs/runpod_benchmark.md` with everything.

- [ ] `docs/runpod_benchmark.md` exists, all numbers populated
...
- [ ] Add it to `docs/runpod_benchmark.md` in the "manually captured" section
...
- [ ] `docs/runpod_benchmark.md` updated with both Pod and Serverless sections side-by-side
...
**8.1 Fill in the report's Scaling Implications section** — open `docs/runpod_benchmark.md` and complete the bottom section:
...
- [ ] `docs/runpod_benchmark.md` is complete (no `<TBD>` left)
...
- [ ] Commit `docs/runpod_benchmark.md` so the data survives
